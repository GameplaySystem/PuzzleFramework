...
The canonical update and framework-first push sequence is documented in the
[repository workflow](https://github.com/GameplaySystem/PuzzleFramework/blob/main/docs/Workflow/FrameworkPackageDependencyWorkflow.md).
